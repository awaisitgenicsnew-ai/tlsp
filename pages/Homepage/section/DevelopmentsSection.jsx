...
export default function DevelopmentsSection() {
  ...
  const highlights = [
    ...
    { icon: <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5"><path d="M3 21h18M8 21v-4h8v4M5 21V7l8-4 8 4v14M12 3v18M6 10h.01M18 10h.01M6 14h.01M18 14h.01"></path></svg>, num: "Design By", lbl: "Killa" }
  ];
