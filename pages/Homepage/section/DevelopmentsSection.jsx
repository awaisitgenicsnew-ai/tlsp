...
export default function DevelopmentsSection() {
  ...
  const highlights = [
    ...
    { icon: <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5"><path d="M9 20l-6-2V6l6-2 6 2 6-2v14l-6 2-6-2z"></path><path d="M9 4v14M15 6v14"></path></svg>, num: "Design By", lbl: "Killa" }
  ];
